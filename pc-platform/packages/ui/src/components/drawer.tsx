...
export const sheetVariants = cva(
  'fixed z-50 gap-4 bg-cyber-900 p-6 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-400 data-[state=open]:animate-in data-[state=closed]:animate-out border-border/70',
  {
    variants: {
      side: {
...
export const SheetHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-2 text-center sm:text-left border-b border-border/40 pb-4',
      className,
    )}
    {...props}
  />
